...
- **Repo — STILL PENDING:** John is creating the GitHub repo himself; this local repo has no remote yet. **Once he gives the URL:** `git remote add origin <url>`, push `main`, enable Pages (Settings → Pages → Source: GitHub Actions) in the repo settings.
