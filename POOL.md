...
- **Repo — LIVE 2026-07-01:** [github.com/AirPengwn/pool](https://github.com/AirPengwn/pool). Remote wired up (`git remote add origin`), the placeholder GitHub-generated README merged in (`--allow-unrelated-histories`, kept our real README over the one-liner), pushed to `main`. **Still needs John to flip one repo setting** (I have no `gh` CLI here to do it remotely): Settings → Pages → Source: **GitHub Actions**. Once set, the already-pushed `deploy.yml` workflow will publish to `https://airpengwn.github.io/pool/` automatically (it already ran on this push — check the Actions tab).
